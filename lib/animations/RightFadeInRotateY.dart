...
class RightFadeInRotateY extends StatefulWidget {
  final Widget child;
  ...
  const RightFadeInRotateY({Key? key, required this.child, this.startDuration, this.animationDuration, this.size, this.parentObject}) : super(key: key);

  @override
  _RightFadeInRotateYState createState() => _RightFadeInRotateYState();
}

class _RightFadeInRotateYState extends State<RightFadeInRotateY> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    Library.debugPrint(animationID + " " + "RightFadeInRotateY");
        ...
        return Opacity(
          ...
          child: Transform(
            ...
            transform: Matrix4.identity()
              ..setEntry(3, 2, 0.001)
              ..setEntry(0, 3, size * _animation.value)
              ..rotateY((3.14 / 6) * _animation.value),
          ),
        );
      },
    );
