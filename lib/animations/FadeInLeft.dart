...
class FadeInLeft extends StatefulWidget {
  ...
  const FadeInLeft({Key? key, required this.child, this.startDuration, this.animationDuration, this.size, this.parentObject}) : super(key: key);
...
class _FadeInLeftState extends State<FadeInLeft> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    Library.debugPrint(animationID + " " + "FadeInLeft");
    ...
    Timer(startDuration!, () {
      ...
      Library.debugPrint("FadeInLeft status : " + _controller.status.toString());
    });
  }
